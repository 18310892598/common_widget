...
public class CardView extends FrameLayout {
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.hasValue(R.styleable.CardView_oCardBackgroundColor)) {
            backgroundColor = a.getColorStateList(R.styleable.CardView_oCardBackgroundColor);
        } else {
        ...
        float radius = a.getDimension(R.styleable.CardView_oCardCornerRadius, 0);
        float elevation = a.getDimension(R.styleable.CardView_oCardElevation, 0);
        float maxElevation = a.getDimension(R.styleable.CardView_oCardMaxElevation, 0);
        mCompatPadding = a.getBoolean(R.styleable.CardView_oCardUseCompatPadding, false);
        mPreventCornerOverlap = a.getBoolean(R.styleable.CardView_oCardPreventCornerOverlap, true);
        int defaultPadding = a.getDimensionPixelSize(R.styleable.CardView_oContentPadding, 0);
        mContentPadding.left = a.getDimensionPixelSize(R.styleable.CardView_oContentPaddingLeft,
                defaultPadding);
        mContentPadding.top = a.getDimensionPixelSize(R.styleable.CardView_oContentPaddingTop,
                defaultPadding);
        mContentPadding.right = a.getDimensionPixelSize(R.styleable.CardView_oContentPaddingRight,
                defaultPadding);
        mContentPadding.bottom = a.getDimensionPixelSize(R.styleable.CardView_oContentPaddingBottom,
                defaultPadding);
    ...
    public RoundRectDrawableWithShadow getShadowDrawable() {
        return (RoundRectDrawableWithShadow) mCardViewDelegate.getCardBackground();
    }

    public void setLightFair(boolean fair) {
        getShadowDrawable().setLightFair(fair);
    }

    public void setStartColor(int mShadowStartColor) {
        getShadowDrawable().setmShadowStartColor(mShadowStartColor);
    }

    public void setEndColor(int mShadowEndColor) {
        getShadowDrawable().setmShadowEndColor(mShadowEndColor);
    }
