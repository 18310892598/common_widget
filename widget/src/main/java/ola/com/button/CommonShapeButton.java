...
public class CommonShapeButton extends AppCompatButton {
    ...
    private GradientDrawable normalGradientDrawable2 = null;
    ...
    private void init(AttributeSet attrs) {
        ...
        normalGradientDrawable2 = new GradientDrawable();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mStartColor != 0xFFFFFFFF && mEndColor != 0xFFFFFFFF) {
            ...
            if (mNoSelectColor != 0) {
                normalGradientDrawable2.setColor(mNoSelectColor);
            }
        }
        switch (mShapeMode) {
            case 0:
                normalGradientDrawable.setShape(GradientDrawable.RECTANGLE);
                normalGradientDrawable2.setShape(GradientDrawable.RECTANGLE);
                break;
            case 1:
                normalGradientDrawable.setShape(GradientDrawable.OVAL);
                normalGradientDrawable2.setShape(GradientDrawable.OVAL);
                break;
            case 2:
                normalGradientDrawable.setShape(GradientDrawable.LINE);
                normalGradientDrawable2.setShape(GradientDrawable.LINE);
                break;
            case 3:
                normalGradientDrawable.setShape(GradientDrawable.RING);
                normalGradientDrawable2.setShape(GradientDrawable.RING);
                break;
        }
        //统一设置圆角半角
        if (mCornerPosition == -1) {
            normalGradientDrawable.setCornerRadius(mCornerRaius);
            normalGradientDrawable2.setCornerRadius(mCornerRaius);
        } else {
            //根据圆角位置设置圆角半径
