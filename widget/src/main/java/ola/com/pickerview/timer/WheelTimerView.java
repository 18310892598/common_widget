...
import ola.com.pickerview.adapter.WheelAdapter;
import ola.com.pickerview.interfaces.IPickerViewData;
import ola.com.pickerview.listener.LoopViewGestureListener;
import ola.com.pickerview.listener.OnItemSelectedListener;
import ola.com.pickerview.utils.OnItemSelectedRunnable;

/**
 * 3d滚轮控件
 */
public class WheelTimerView extends View {
    ...
    // 条目间距倍数
    static final float LINE_SPACING_MULTIPLIER = 3.0F;
    boolean isLoop;
    ...
    public WheelTimerView(Context context) {
        this(context, null);
    }

    public WheelTimerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        if (attrs != null) {
            ...
            textColorOut = a.getColor(R.styleable.pickerview_wheelview_textColorOut, textColorOut);
            textColorCenter = a.getColor(R.styleable.pickerview_wheelview_textColorCenter, textColorCenter);
            dividerColor = a.getColor(R.styleable.pickerview_wheelview_dividerColor, dividerColor);
    ...
    private void measureTextWidthHeight() {
        ...
        itemHeight = LINE_SPACING_MULTIPLIER * maxTextHeight;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (counter < itemsVisible) {
            ...
            float itemHeight = maxTextHeight * LINE_SPACING_MULTIPLIER;
