...
public class ChinaDate {
    ...
    private final static String[] N_STR_1 = new String[]{"", "正", "二", "三", "四",
            "五", "六", "七", "八", "九", "十", "冬", "腊"};
    ...
    public static ArrayList<String> getMonths(int year) {
        ...
        for (int i = 1; i < N_STR_1.length; i++) {
            baseMonths.add(N_STR_1[i] + "月");
        }
        if (leapMonth(year) != 0) {
            baseMonths.add(leapMonth(year), "闰" + N_STR_1[leapMonth(year)] + "月");
        }
        return baseMonths;
    }
