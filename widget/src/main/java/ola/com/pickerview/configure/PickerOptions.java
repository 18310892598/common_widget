package ola.com.pickerview.configure;
...
import ola.com.pickerview.listener.CustomListener;
...
public class PickerOptions {
    ...
    public int xOffsetOne, xOffsetTwo, xOffsetThree;//x轴偏移量
    ...
    public String labelYear, labelMonth, labelDay, labelHours, labelMinutes, labelSeconds;//单位
    public int xOffsetYear, xOffsetMonth, xOffsetDay, xOffsetHours, xOffsetMinutes, xOffsetSeconds;//单位
