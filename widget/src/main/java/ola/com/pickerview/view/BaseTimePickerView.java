...
public class BaseTimePickerView {
    ...
    public void dismissImmediately() {
        ...
        if (onDismissListener != null) {
            onDismissListener.onDismiss(BaseTimePickerView.this);
        }
    ...
    public BaseTimePickerView setOnDismissListener(OnDismissListener onDismissListener) {
        this.onDismissListener = onDismissListener;
        return this;
    }

    public BaseTimePickerView setCancelable(boolean isCancelable) {
